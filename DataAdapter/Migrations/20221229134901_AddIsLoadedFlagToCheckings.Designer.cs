...
namespace DataAdapter.Migrations
{
    ...
    [Migration("20221229134901_AddIsLoadedFlagToCheckings")]
    partial class AddIsLoadedFlagToCheckings
    {
            ...
            modelBuilder.Entity("Models.Database.CpanelWhmCheckModel", b =>
                {
                    ...
                    b.Property<bool>("IsDublicatesFilledToDb")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("is_dublicates_filled_to_db");
            ...
            modelBuilder.Entity("Models.Database.UserModel", b =>
                {
                    ...
                    b.Property<int>("TotalPayoutCompletedCount")
                        .HasColumnType("int")
                        .HasColumnName("total_payout_count");

                    b.Property<double>("TotalPayoutCompletedSummary")
                        .HasColumnType("double")
                        .HasColumnName("total_payout_summary");
